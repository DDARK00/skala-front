...
canvas.addEventListener(
    ...
    () => {
        ...
        if (!globe.dragging) {
            globe.targetRotationSpeed =
                globe.autoRotationSpeed;
...
function project(point) {
    ...
    */
    ...
    const cosY =
        Math.cos(globe.rotation);

    const sinY =
        Math.sin(globe.rotation);
